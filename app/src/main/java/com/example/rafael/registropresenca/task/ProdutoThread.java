 ...
 */
public class ProdutoThread extends AsyncTask<String, Void, Boolean> {
    ...
    public ProdutoThread(Context contexto, ProgressDialog dialog) {
            ...
            case "PR":
                ...
                if (jsonArray != null) {
                    try {
                        ...
                        produto = new Produto();
                        jsonObject =  (JSONObject) jsonArray.getJSONObject(0);
                        produto.setCodigo(jsonObject.getLong("CODIGO"));
...
//                    editor.commit();
                    ...
                    if(DadosUsuario.getUsuario().getForma().equals("D1")){
...
//                    contexto.startActivity(intent);
            ...
            case "PR":
                dialog.dismiss();
                if(flag){
                    Toast.makeText(contexto, "PRECO: R$ "+ String.valueOf(String.format(Locale.US,"%.2f",produto.getVenda())), Toast.LENGTH_LONG).show();
                    ((ConsultaActivity) contexto).lblPrecoProduto.setText("R$ " + String.valueOf(String.format(Locale.US,"%.2f",produto.getVenda())));
                    ((ConsultaActivity) contexto).lblDescricaoProduto.setText(produto.getDescricao());
//                    ((ConsultaActivity) contexto).finish();
//                    Intent intent = (new Intent(contexto, ConsultaActivity.class));
//                    intent.putExtra("desc", produto.getDescricao());
//                    intent.putExtra("precov",String.valueOf(String.format(Locale.US, "%.2f",produto.getVenda())));
//                    contexto.startActivity(intent);
